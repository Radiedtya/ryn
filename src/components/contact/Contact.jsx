...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "Email",
    description: "ryndevv@gmail.com",
  },
  {
    icon: faPhone,
    title: "Hubungi Saya",
    description: "+62 882-2215-0964",
  },
];
